...
<?php
    ...
    if($count == 0) {
        echo "  <tr>
                ...
                <tr>
                    <td height='15' colspan='7' align='center' valign='middle'><strong>Total</strong></td>
    ...
    // jika data tidak ada
        ...
        while ($data = mysqli_fetch_assoc($query)) {
            ...
            echo "  <tr>
                        ...
                        <td width='120' height='13' align='center' valign='middle'>$data[jenis_kendaraan]</td>
                        <td width='110' height='13' align='center' valign='middle'>$data[no_plat_kendaraan]</td>
                        <td style='padding-left:5px;' width='150' height='13' valign='middle'>$data[nama_paket]</td>
                        <td style='padding-right:5px;' width='120' height='13' align='right' valign='middle'>Rp. ".format_rupiah($jumlah)."</td>
                    </tr>";
            $no++;
